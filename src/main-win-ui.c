...
static GtkActionEntry main_win_actions[]=
{
    {"FileMenu", NULL, N_("_File"), NULL, NULL, NULL},
        ...
        {"CrNewFolder", "folder", N_("Create _Folder"), "<Ctrl><Shift>N", NULL, G_CALLBACK(bounce_action)},
...
static GtkToggleActionEntry main_win_toggle_actions[]=
{
    ...
    {"ShowPlaces", NULL, N_("Show _Places"), "<Ctrl>P", NULL, G_CALLBACK(on_show_places), FALSE},
